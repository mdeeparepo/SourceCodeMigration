...
public class TC011_VerifyTheTMGAllocationPageDetails {
    ...
    public void setupTestData() throws Exception {
        ...
        List<HashMap<String, String>> testData2 = ReadDatafromExcel
                .data("src/test/resources/TestData/StationH.xlsx", "TestData_TMG");
    ...
    public void executeTest() throws Exception {
        try {
            ...
            TMGApplicationPage tmgapplicationpage=new TMGApplicationPage();
            tmgapplicationpage.LoginToTMGPortal("1000071558", DT_PASSWORD,"TMG Portal");
            tmgapplicationpage.verifyProjectAllocationDetails();
    ...
    public static void main(String[] args) {
        TC011_VerifyTheTMGAllocationPageDetails test = new TC011_VerifyTheTMGAllocationPageDetails();
        try {
            test.setupTestData();
            test.executeTest();
        } catch (Exception e) {
