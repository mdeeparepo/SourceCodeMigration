...
public class TC012_VerifyInfoSecAwarenessFromQualityPortal {
    ...
    public static void main(String[] args) {
        TC012_VerifyInfoSecAwarenessFromQualityPortal test = new TC012_VerifyInfoSecAwarenessFromQualityPortal();
        try {
            test.setupTestData();
            test.executeTest();
        } catch (Exception e) {
