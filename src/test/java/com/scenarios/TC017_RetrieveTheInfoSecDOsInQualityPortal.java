...
public class TC017_RetrieveTheInfoSecDOsInQualityPortal {
    ...
    public void executeTest() throws Exception {
        try {
            ...
            qualityapplicationpage.VerifyInfoSecDos();
            qualityapplicationpage.RetriveDosDescrption();
    ...
    public static void main(String[] args) {
        TC017_RetrieveTheInfoSecDOsInQualityPortal test = new TC017_RetrieveTheInfoSecDOsInQualityPortal();
        try {
            test.setupTestData();
            test.executeTest();
        } catch (Exception e) {
