...
public class TC010_VerifyQualityPortalPage {
    ...
    public void executeTest() throws Exception {
        try {
            ...
            qualityapplicationpage.VerifyPrimeHighLightsAndVersion();
    ...
    public static void main(String[] args) {
        TC010_VerifyQualityPortalPage test = new TC010_VerifyQualityPortalPage();
        try {
            test.setupTestData();
            test.executeTest();
        } catch (Exception e) {
