...
public class TC019_RetreiveLeaveBalancesELAndOH {
    ...
    public void executeTest() throws Exception {
        try {
            ...
            dhrapplicationpage.RetreiveLeaveBalances();
    ...
    public static void main(String[] args) {
        TC019_RetreiveLeaveBalancesELAndOH test = new TC019_RetreiveLeaveBalancesELAndOH();
        try {
            test.setupTestData();
            test.executeTest();
        } catch (Exception e) {
