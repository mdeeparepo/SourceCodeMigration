...
import com.stationhPages.DHRApplicationPage;
import com.stationhPages.LoginPage;
import com.stationhPages.MainDashBoardPage;


public class TC018_LoginToDHRAsSSOUserandGetContactInfoDetails {
    ...
    public void setupTestData() throws Exception {
        ...
        List<HashMap<String, String>> testData2 = ReadDatafromExcel
                .data("src/test/resources/TestData/StationH.xlsx", "TestData_DHR");
    ...
    public void executeTest() throws Exception {
        try {
            ...
            DHRApplicationPage dhrapplicationpage=new DHRApplicationPage(); 
            ...
            dhrapplicationpage.LoginIntoDHR();
            dhrapplicationpage.RetreiveContactInfo();
    ...
    public static void main(String[] args) {
        TC018_LoginToDHRAsSSOUserandGetContactInfoDetails test = new TC018_LoginToDHRAsSSOUserandGetContactInfoDetails();
        try {
            test.setupTestData();
            test.executeTest();
        } catch (Exception e) {
