...
public class TC002_VerifyTheConcurApplication {
    ...
    static String DT_EnterpriseAppName="Topia";
    ...
    public void setupTestData() throws Exception {
        ...
        List<HashMap<String, String>> testData2 = ReadDatafromExcel
                .data("src/test/resources/TestData/StationH.xlsx", "TestData_Concur");
        ...
        DT_TITLE=testData2.get(testRow).get("DT_TITLE");
    ...
    public void executeTest() throws Exception {
        try {
            ...
            ConcurApplicationPage concurapplicationpage=new ConcurApplicationPage(); 
            ...
            concurapplicationpage.VerifyTitleofConcur(DT_TITLE);
            concurapplicationpage.NavigateToAppCenter();
            concurapplicationpage.VerifyTopiaApp(DT_EnterpriseAppName);
    ...
    public static void main(String[] args) {
        TC002_VerifyTheConcurApplication test = new TC002_VerifyTheConcurApplication();
        try {
            test.setupTestData();
            test.executeTest();
        } catch (Exception e) {
