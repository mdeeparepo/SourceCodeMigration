...
import com.stationhPages.HexaGuruApplicationPage;
import com.stationhPages.LoginPage;
import com.stationhPages.MainDashBoardPage;


public class TC020_NavigateToMyTrainingsSection {
    ...
    public void setupTestData() throws Exception {
        ...
        List<HashMap<String, String>> testData2 = ReadDatafromExcel
                .data("src/test/resources/TestData/StationH.xlsx", "TestData_HexaGuru");
    ...
    public void executeTest() throws Exception {
        try {
            ...
            HexaGuruApplicationPage hexaguruapplicationpage=new HexaGuruApplicationPage();
            ...
            hexaguruapplicationpage.RetrieveTrainingNames();
    ...
    public static void main(String[] args) {
        TC020_NavigateToMyTrainingsSection test = new TC020_NavigateToMyTrainingsSection();
        try {
            test.setupTestData();
            test.executeTest();
        } catch (Exception e) {
