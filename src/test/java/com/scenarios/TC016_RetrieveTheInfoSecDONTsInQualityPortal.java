...
public class TC016_RetrieveTheInfoSecDONTsInQualityPortal {
    ...
    public void executeTest() throws Exception {
        try {
            ...
            qualityapplicationpage.VerifyInfoSecDonts();
            qualityapplicationpage.RetriveDontsDescrption();
    ...
    public static void main(String[] args) {
        TC016_RetrieveTheInfoSecDONTsInQualityPortal test = new TC016_RetrieveTheInfoSecDONTsInQualityPortal();
        try {
            test.setupTestData();
            test.executeTest();
        } catch (Exception e) {
